...
@section('content-header')
                ...
                <section class="content-header">
                    <h1> <i class="fa fa-hospital-o"></i> Sub District  Target <small>Control panel</small> </h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ URL::to('/') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="{{ URL::to('subdistrictpopulations') }}"><i class="fa fa-hospital-o"></i> Sub District Target</a></li>
...
<!-- title row -->
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">Add a Target</h2>                            
                        </div><!-- /.col -->
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="box box-primary">
                          {{ Form::open(array('url'=> 'subdistrictpopulations','method'=>'post')) }}
            ...
            <div class="box box-primary">
                            <div class="box-body">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        {{ Form::label('chn_less_than_5_yrs','Chn < 5 yrs ') }} <span id="chn_less_than_5_yrs_percentage"> </span>
