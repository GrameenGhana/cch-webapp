...
@section('content-header')
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Sub District  Target</li>
                    </ol>
                </section>
@stop
...
<!-- title row -->
				    ...
				    <a class="btn btn-small btn-success" href="{{ URL::to('subdistrictpopulations/create') }}"><i class="fa fa-plus-circle"></i> Add a Target</a>
                            </h2>                            
                        </div><!-- /.col -->
                    </div>
				...
				<label>Select year : </label>
                                  <select name="year" onchange="if (this.value) window.location.href=this.value">
                                    <option value="/cch/yabr3/getSubDistrictPopulationData?year=2015">2015</option>
                                    <option value="/cch/yabr3/getSubDistrictPopulationData?year=2014">2014</option>
                                    <option value="/cch/yabr3/getSubDistrictPopulationData?year=2013">2013</option>
                                    <option value="/cch/yabr3/getSubDistrictPopulationData?year=2012">2012</option>
                                  </select>
	 ...
	 <td> {{ $value->district->name}} </td>
					  <td> {{ $value->year}} </td>
						  ...
						  <td>
							<a title="Edit" class="btn btn-sm btn-info" href="{{ URL::to('subdistrictpopulations/' . $value->id . '/edit') }}"><i class="fa fa-pencil"></i></a>
