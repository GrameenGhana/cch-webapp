           ...
           <script type="text/javascript">
             ...
             <table id="bulkedittable" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan='2'><strong>Sub District Totals  :</strong> {{$subdistrict->name}}-{{$year}}</td>
                        
                        <td>{{ $subdistrictpopulation->district_percentage}}</td>
                        <td>{{ $subdistrictpopulation->population }}</td>
                        <td>{{ $subdistrictpopulation->expected_pregnancies }}</td>
                        ...
                        <td>{{ $subdistrictpopulation->chn_less_than_5_yrs }}</td>
...
//alert(colsTolast+" - "+columnIndex);
            $("#" + tableID + " tr:nth-last-child("+colsTolast+")").children("td:nth-child(" + (columnIndex-1) + ")").html(toFixed(tot, 2));
            return tot;
    }
