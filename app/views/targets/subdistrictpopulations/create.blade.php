...
@section('content-header')
                ...
                <section class="content-header">
                    <h1> <i class="fa fa-hospital-o"></i> Sub Districts Population </h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ URL::to('/') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="{{ URL::to('targets/population/subdistricts') }}"><i class="fa fa-hospital-o"></i> Sub Districts Population</a></li>
...
<!-- title row -->
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">Add Subdistrict Population Information</h2>                            
                        </div><!-- /.col -->
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="box box-primary">
                          {{ Form::open(array('url'=> 'targets/population/subdistricts','method'=>'post')) }}
                          ...
                          <div class="box-body">
                           ...
                           <div class="form-group">
                                ...
                                {{ Form::select('region',$regions,Input::old('region'),array('class'=>'form-control','placeholder'=>'Enter Region to which this district belongs'))}}
                            </div>
                           ...
                           <div class="form-group">
                              <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{ Form::select('year', array('2012'=>'2012','2013'=>'2013','2014'=>'2014','2015'=>'2015','2016'=>'2016'), Input::old('year'),array('class'=>'form-control','placeholder'=>'Select year')) }}
                                </div>  

                                <div class="col-md-6">
                                {{ Form::label('district_percentage','Percentage of district (%)') }}
                                {{ Form::text('district_percentage',Input::old('district_percentage'),array('class'=>'form-control','placeholder'=>'Enter percentage')) }}
                            </div>
                            ...
                            <div class="box-body">
                              ...
                              <div class="row">
                                    <div class="col-md-6 form-group">
                                        {{ Form::label('expected_pregnancies','Expected Pregnancies  ') }} <span id="expected_pregnancies_percentage"> </span>
...
<!--                                    <div class="form-group">
                                    ...
                                    <div class="col-md-6 form-group">
                                        {{ Form::label('wifa_15_49_yrs','Wifa 15-49 yrs ') }} <span id="wifa_15_49_yrs_percentage"> </span>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        {{ Form::label('chn_12_23_mnths','Chn 12-23 months  ') }} <span id="chn_12_23_mnths_percentage"> </span>
...
<!--                                    <div class="form-group">
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        {{ Form::label('chn_less_than_5_yrs','Chn less than 5 yrs ') }} <span id="chn_less_than_5_yrs_percentage"> </span>
                              ...
                              <div class="row">
                                    <div class="col-md-6 form-group">
                                        {{ Form::label('men_women_50_to_60_yrs','Men & Women 50-60 yrs ') }} <span id="men_women_50_to_60_yrs_percentage"> </span>
                         ...
                         <div class="box-footer">
                           {{ Form::submit('Add Population',array('class'=>'btn btn-primary')) }}
                       </div>
...
@section('script')
    ...
    $("select[name='district']").change(function(){ 
      // get the selected option value of region
      var optionValue = $("select[name='district']").val();   
    ...
    function getDistrictTotalPopulation(){
      ...
      $.ajax({
            ...
            cache: false,
            dataType:"json",
            url : address + "/getDistrictTotalPopulation",
