...
@section('content-header')
                ...
                <section class="content-header">
                    <h1> <i class="fa fa-hospital-o"></i> Sub Districts Population Data </h1>
                    <ol class="breadcrumb">
                        <li><a href="{{ URL::to('/') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="{{ URL::to('/targets/population/subdistricts') }}"><i class="fa fa-hospital-o"></i> Sub Districts Population Information</a></li>
...
<!-- title row -->
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">Update Subdistrict Population Information</h2>                            
                        </div><!-- /.col -->
                    </div>
		    ...
		    <div class="row">
		        <div class="col-md-6">
			       ...
			       {{ Form::open(array('url'=> 'targets/population/subdistricts/'.$pop->id,'method'=>'put')) }}
					...
					@endif
                           <div class="form-group">
                                ...
                                {{ Form::select('region',$regions,$pop->region,array('class'=>'form-control','placeholder'=>'Enter Region to which this district belongs'))}}
