...
<section class="content-header">
    <h1> <i class="fa fa-hospital-o"></i>Sub Districts Populations in {{$district->name}} </h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="box">
        <div class="box-body table-responsive">
            ...
            <h2>Sub District Populations &raquo; {{$district->name}} - <strong>{{$year}}</strong></h2>
            ...
            <table id="bulkedittable" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Population<br />{{ $districtpopulation->population }}</th>
...
href="{{ URL::to('/targets/population/zones/bulkedit/subdistrict/' . $value->subdistrict->id . '/'.$year) }}"><i class=""></i> Zones</td>
