...
@section('content-header')
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ URL::to('targets/population/districts') }}"><i class="fa fa-hospital-o"></i> District Populations</a></li>
...
<!-- title row -->
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">Update Population Information</h2>                            
                        </div><!-- /.col -->
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                   ...
                   {{ Form::open(array('url'=> 'targets/population/districts/'.$pop->id,'method'=>'put')) }}
...
<!--                                    <div class="form-group">
          ...
          {{ Form::submit('Update Population Information',array('class'=>'btn btn-primary')) }}
                                    </div>
