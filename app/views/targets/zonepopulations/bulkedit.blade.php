    ...
    <div class="box">
        <div class="box-body table-responsive">
           ...
           @if($type=="subdistrict_id")  
                 <h2>Sub District Populations &raquo; {{$district->name}}  &raquo; {{$subdistrict->name}} - <strong>{{$year}}</strong></h2>
            <script type="text/javascript">
                 var columnsToLast=3;
                </script>
          @else 
                <h2>District Populations &raquo; {{$district->name}} - <strong>{{$year}}</strong></h2>
           <script type="text/javascript">
                 var columnsToLast=2;
                </script>
                @endif
