...
@section('content-header')
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ URL::to('targets/population/zones') }}"><i class="fa fa-hospital-o"></i> Zones Population</a></li>
...
<!-- title row -->
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">Add Zone Population Data</h2>                            
                        </div><!-- /.col -->
                    </div>
                        ...
                        <div class="box box-primary">
                          ...
                          <div class="box-body">
                           ...
                           <div class="form-group">
                               ...
                               {{ Form::select('zoneselected',$zones,Input::old('zoneselected'),array('class'=>'form-control','placeholder'=>'Select zone'))}}
