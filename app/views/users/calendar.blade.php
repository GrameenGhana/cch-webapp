...
<section class="content-header">
    ...
    <ol class="breadcrumb">
         ...
         <li>
     		<a href="{{ URL::to('users') }}"><i class="fa fa-hospital-o"></i> Users</a>
	</li>
...
<section class="content invoice">
	<div class="row">
		<div class="col-xs-12">
        		<h2 class="page-header">{{ $user->first_name }} {{$user->last_name}}'s Calendar <br/><h4> Location(s):{{$user->facilityList()}}</h4> </h2>
        	</div>
	</div>
